...
class Ui_Homepage(object):
    def setupUi(self, Homepage):
        ...
        self.pushButton_Update_photo.setGeometry(QtCore.QRect(230, 110, 101, 28))
        font = QtGui.QFont()
        ...
        self.label_Username.setGeometry(QtCore.QRect(230, 70, 191, 41))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        ...
        self.pushButton_Log_Out.setGeometry(QtCore.QRect(360, 20, 61, 28))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_Download_Key_Pairs.setGeometry(QtCore.QRect(210, 150, 151, 28))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setBold(True)
        font.setWeight(75)
        self.pushButton_Download_Key_Pairs.setFont(font)
        self.pushButton_Download_Key_Pairs.setStyleSheet("color: rgb(99, 148, 255);")
        ...
        self.pushButton_Send_File.setGeometry(QtCore.QRect(140, 290, 131, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_Send_Message_background.setGeometry(QtCore.QRect(290, 200, 131, 121))
        ...
        self.label_Send_Message_Icon.setGeometry(QtCore.QRect(320, 220, 71, 61))
        ...
        self.pushButton_Send_Message.setGeometry(QtCore.QRect(290, 290, 131, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_Check_Message_Icon.setGeometry(QtCore.QRect(240, 350, 71, 71))
        ...
        self.pushButton_Check_Message.setGeometry(QtCore.QRect(140, 420, 281, 21))
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButton_Download_Key_Pairs.clicked.connect(self.download_private_key)

    def retranslateUi(self, Homepage):
        _translate = QtCore.QCoreApplication.translate
        Homepage.setWindowTitle(_translate("Homepage", "Homepage"))
        self.pushButton_Update_photo.setText(_translate("Homepage", "Update photo"))
        ...
        self.pushButton_Send_File.setText(_translate("Homepage", "Send a file"))
        self.pushButton_Send_Message.setText(_translate("Homepage", "Send a message"))
        self.pushButton_Check_Message.setText(_translate("Homepage", "Chcek message"))
    ...
    def download_private_key(self):
        ...
        # show succ info
        self.show_info("You private key file has been downloaded.")
