...
def main():
    ...
    # account 7
    wallet_key7 = "14ed80e385c55297a9eb9a1e21612632ea2c81f01383d9eb18c5786bbabb9e72"
    # get account
    wallet_account = get_wallet_account(wallet_key7)
    # get the most recent contract deployed
    certification = RSACertification[3]
    # show certificate information
    user_name = certification.getUserName({"from": wallet_account})
    public_key_bytes_array = certification.getPublicKey({"from": wallet_account})
    public_key = b""
